...
if os.path.isfile('config.json'):
    ...
    AddValuesInCPP(conf,["RELAY_PIN","BUTTON_PIN","DEBOUNCE_TIME","BUTTON_PRESS_COUNT_MAX","IDXDEVICE","NOMMODULE"])
    ...
    if check and int(check) == 1:
        ...
        if check and int(check) == 1:
            AddDefine("USE_MQTT")
            AddValuesInCPP(conf,["TOPICIN","TOPICOUT","MQTT_SERVER","MQTT_LOGIN","MQTT_PASSWORD","MQTT_PORT"],"MQTT")
